                                ...
                                <div class="form-group clearfix">
                                    <div class="icheck-success d-inline">
                                        ...
                                        <label for="checkboxSuccess1" style="text-align:justify;">
                                           Toda información que se ha seleccionado esta revisada a detalle y es veridica.
                                        </label>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
      ...
      $('input[type="file"]').on('change', function(){
            ...
            if(ext == "PDF" || ext == "pdf" || ext == "docx"|| ext == "DOCX"|| ext == "zip" || ext == "png" || ext == "PNG" || ext == "jpg" || ext == "JPG" || ext == "jpeg"  || ext == "JPEG" || ext == "rar" || ext == "xlsx"  || ext == "xls" ){
                if($(this)[0].files[0].size > 31457280){ //---- 30 MB Aqui se ponen todas las extensiones que querramos
